...
//    private static final int THREAD_POOL = 10; //I will place a constant here for more sophisticated way but ultimately 
    ...
    static class ConfigHandler implements HttpHandler {
        ...
        private void handlePost(HttpExchange t) throws IOException {
            ...
            String body = new String(is.readAllBytes(), StandardCharsets.UTF_8);      // TODO: REPLACE "" WITH Logic to read stream
            ...
            t.sendResponseHeaders(200, response.getBytes().length);
                        t.sendResponseHeaders(200, response.getBytes(StandardCharsets.UTF_8).length);
            try (OutputStream os = t.getResponseBody()) { // FIX: must write body
                os.write(response.getBytes(StandardCharsets.UTF_8));
            }
