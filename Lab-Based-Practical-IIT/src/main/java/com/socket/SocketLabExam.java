            ...
            */
            while(true) {
                ...
                */
                ...
                System.out.println("New data node connected: " + clientSocket.getInetAddress());
        ...
        public void run() {
            try {
                ...
                */
                ...
                // Protocol Logic
                String request;
                String lastRequest = ""; // FIX: store last non-null line for processing
                ...
                */
                while((request = in.readLine()) != null) {
                    ...
                    /* TODO 13: Transform Logic.
                       ...
                       [2 Marks]
                    */
                    String response = "Processed: " + lastRequest.toUpperCase(); // TODO: REPLACE "" WITH TRANSFORM LOGIC
